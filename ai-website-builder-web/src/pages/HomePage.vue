    ...
    <div class="container">
      ...
      <div class="input-section">
        ...
        <div class="input-actions">
          <a-button type="primary" size="large" @click="createNewApp" :loading="creating">
            <template #icon>
              <span>↑</span>
            </template>
          </a-button>
...
import { createApp, getChoicenessAppVoPage, getLoginUserAppVoPage } from '@/api/appController'
...
const loadMyApps = async () => {
  ...
  try {
    const res = await getLoginUserAppVoPage({
      request: {
...
const loadFeaturedApps = async () => {
  try {
    const res = await getChoicenessAppVoPage({
      request: {
